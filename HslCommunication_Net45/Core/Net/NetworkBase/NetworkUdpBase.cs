...
namespace HslCommunication.Core.Net
{
    ...
    public class NetworkUdpBase<TTransform> : NetworkBase, IReadWriteNet where TTransform : IByteTransform, new()
    {
        /// <summary>
        /// 实例化一个默认的对象
        /// </summary>
        ...
        public virtual OperateResult<byte[]> ReadFromCoreServer( byte[] value )
        {
            ...
            try
            {
                ...
                server.SendTo( value, value.Length, SocketFlags.None, ServerEndPoint );
