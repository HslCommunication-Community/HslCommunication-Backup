    ...
    public void AddRead(JPanel panel){
        ...
        button1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (button1.isEnabled() == false) return;
                super.mouseClicked(e);
                DemoUtils.ReadResultRender(keyenceMcNet.ReadBool(textField1.getText()),textField1.getText(), textArea1, jsp );
            }
        });
        ...
        button3.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                DemoUtils.ReadResultRender(keyenceMcNet.ReadInt16(textField1.getText()),textField1.getText(), textArea1, jsp );
            }
        });
        ...
        button5.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                DemoUtils.ReadResultRender(keyenceMcNet.ReadInt32(textField1.getText()),textField1.getText(), textArea1, jsp );
            }
        });
        ...
        button7.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                DemoUtils.ReadResultRender(keyenceMcNet.ReadInt64(textField1.getText()),textField1.getText(), textArea1, jsp );
            }
        });
        ...
        button9.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                DemoUtils.ReadResultRender(keyenceMcNet.ReadFloat(textField1.getText()),textField1.getText(), textArea1, jsp );
            }
        });
        ...
        button10.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                DemoUtils.ReadResultRender(keyenceMcNet.ReadDouble(textField1.getText()),textField1.getText(), textArea1, jsp );
            }
        });
        ...
        button11.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                DemoUtils.ReadResultRender(keyenceMcNet.ReadString(textField1.getText(), Short.parseShort(textField8.getText())),textField1.getText(), textArea1, jsp );
            }
        });
    ...
    public void AddWrite(JPanel panel){
        ...
        button1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                try {
                    DemoUtils.WriteResultRender(keyenceMcNet.Write(textField1.getText(), Boolean.parseBoolean(textField2.getText())), textField1.getText());
                }
                catch (Exception ex){
                    JOptionPane.showMessageDialog(
                            null,
        ...
        button3.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                try {
                    DemoUtils.WriteResultRender(keyenceMcNet.Write(textField1.getText(), Short.parseShort(textField2.getText())), textField1.getText());
                }
                catch (Exception ex){
                    JOptionPane.showMessageDialog(
                            null,
        ...
        button5.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                try {
                    DemoUtils.WriteResultRender(keyenceMcNet.Write(textField1.getText(), Integer.parseInt(textField2.getText())), textField1.getText());
                }
                catch (Exception ex){
                    JOptionPane.showMessageDialog(
                            null,
        ...
        button7.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                try {
                    DemoUtils.WriteResultRender(keyenceMcNet.Write(textField1.getText(), Long.parseLong(textField2.getText())), textField1.getText());
                }
                catch (Exception ex){
                    JOptionPane.showMessageDialog(
                            null,
        ...
        button9.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                try {
                    DemoUtils.WriteResultRender(keyenceMcNet.Write(textField1.getText(), Float.parseFloat(textField2.getText())), textField1.getText());
                }
                catch (Exception ex){
                    JOptionPane.showMessageDialog(
                            null,
        ...
        button10.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                try {
                    DemoUtils.WriteResultRender(keyenceMcNet.Write(textField1.getText(), Double.parseDouble(textField2.getText())), textField1.getText());
                }
                catch (Exception ex){
                    JOptionPane.showMessageDialog(
                            null,
        ...
        button11.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                try {
                    DemoUtils.WriteResultRender(keyenceMcNet.Write(textField1.getText(), textField2.getText()), textField1.getText());
                }
                catch (Exception ex){
                    JOptionPane.showMessageDialog(
                            null,
