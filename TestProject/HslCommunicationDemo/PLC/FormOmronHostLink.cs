...
namespace HslCommunicationDemo
{
    public partial class FormOmronHostLink : Form
    {
        ...
        private void readResultRender<T>( OperateResult<T> result, string address, TextBox textBox )
        {
            ...
            {
                MessageBox.Show( DateTime.Now.ToString( "[HH:mm:ss] " ) + $"[{address}] Read Failed {Environment.NewLine} Because：{result.ToMessageShowString( )}" );
            }
        }
        ...
        private void writeResultRender( OperateResult result, string address )
        {
            ...
            {
                MessageBox.Show( DateTime.Now.ToString( "[HH:mm:ss] " ) + $"[{address}] Write Failed {Environment.NewLine} Because：{result.ToMessageShowString( )}" );
            }
        }
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            {
                MessageBox.Show( "PLC站号输入不正确！" );
                return;
            }

            if (!byte.TryParse( textBox15.Text, out byte SID ))
            {
                MessageBox.Show( "设备标识号输入不正确！" );
                return;
            }
        ...
        {
            // 读取bool变量
            readResultRender( omronHostLink.ReadBool( textBox3.Text ), textBox3.Text, textBox4 );
        }
        private void button_read_short_Click( object sender, EventArgs e )
        {
            // 读取short变量
            readResultRender( omronHostLink.ReadInt16( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_ushort_Click( object sender, EventArgs e )
        {
            // 读取ushort变量
            readResultRender( omronHostLink.ReadUInt16( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_int_Click( object sender, EventArgs e )
        {
            // 读取int变量
            readResultRender( omronHostLink.ReadInt32( textBox3.Text ), textBox3.Text, textBox4 );
        }
        private void button_read_uint_Click( object sender, EventArgs e )
        {
            // 读取uint变量
            readResultRender( omronHostLink.ReadUInt32( textBox3.Text ), textBox3.Text, textBox4 );
        }
        private void button_read_long_Click( object sender, EventArgs e )
        {
            // 读取long变量
            readResultRender( omronHostLink.ReadInt64( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_ulong_Click( object sender, EventArgs e )
        {
            // 读取ulong变量
            readResultRender( omronHostLink.ReadUInt64( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_float_Click( object sender, EventArgs e )
        {
            // 读取float变量
            readResultRender( omronHostLink.ReadFloat( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_double_Click( object sender, EventArgs e )
        {
            // 读取double变量
            readResultRender( omronHostLink.ReadDouble( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_string_Click( object sender, EventArgs e )
        {
            // 读取字符串
            readResultRender( omronHostLink.ReadString( textBox3.Text, ushort.Parse( textBox5.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button24_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( omronHostLink.Write( textBox8.Text, bool.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button22_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( omronHostLink.Write( textBox8.Text, short.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button21_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( omronHostLink.Write( textBox8.Text, ushort.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button20_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( omronHostLink.Write( textBox8.Text, int.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button19_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( omronHostLink.Write( textBox8.Text, uint.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button18_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( omronHostLink.Write( textBox8.Text, long.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button17_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( omronHostLink.Write( textBox8.Text, ulong.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button16_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( omronHostLink.Write( textBox8.Text, float.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button15_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( omronHostLink.Write( textBox8.Text, double.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button14_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( omronHostLink.Write( textBox8.Text, textBox7.Text ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button25_Click( object sender, EventArgs e )
        {
            try
            {
                OperateResult<byte[]> read = omronHostLink.Read( textBox6.Text, ushort.Parse( textBox9.Text ) );
                if (read.IsSuccess)
                {
        ...
        private void ThreadReadServer()
        {
            while (isThreadRun)
            {
                ...
                try
                {
                    OperateResult<short> read = omronHostLink.ReadInt16( textBox12.Text );
                    if (read.IsSuccess)
                    {
                        // 显示曲线
