...
namespace HslCommunicationDemo
{
    public partial class FormKeyenceAscii : Form
    {
        ...
        {
            // 读取bool变量
            readResultRender( keyence_net.ReadBool( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_short_Click( object sender, EventArgs e )
        {
            // 读取short变量
            readResultRender( keyence_net.ReadInt16( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_ushort_Click( object sender, EventArgs e )
        {
            // 读取ushort变量
            readResultRender( keyence_net.ReadUInt16( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_int_Click( object sender, EventArgs e )
        {
            // 读取int变量
            readResultRender( keyence_net.ReadInt32( textBox3.Text ), textBox3.Text, textBox4 );
        }
        private void button_read_uint_Click( object sender, EventArgs e )
        {
            // 读取uint变量
            readResultRender( keyence_net.ReadUInt32( textBox3.Text ), textBox3.Text, textBox4 );
        }
        private void button_read_long_Click( object sender, EventArgs e )
        {
            // 读取long变量
            readResultRender( keyence_net.ReadInt64( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_ulong_Click( object sender, EventArgs e )
        {
            // 读取ulong变量
            readResultRender( keyence_net.ReadUInt64( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_float_Click( object sender, EventArgs e )
        {
            // 读取float变量
            readResultRender( keyence_net.ReadFloat( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_double_Click( object sender, EventArgs e )
        {
            // 读取double变量
            readResultRender( keyence_net.ReadDouble( textBox3.Text ), textBox3.Text, textBox4 );
        }

        private void button_read_string_Click( object sender, EventArgs e )
        {
            // 读取字符串
            readResultRender( keyence_net.ReadString( textBox3.Text, ushort.Parse( textBox5.Text ) ), textBox3.Text, textBox4 );
        }
        ...
        private void button22_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( keyence_net.Write( textBox8.Text, short.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button21_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( keyence_net.Write( textBox8.Text, ushort.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button20_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( keyence_net.Write( textBox8.Text, int.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button19_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( keyence_net.Write( textBox8.Text, uint.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button18_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( keyence_net.Write( textBox8.Text, long.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button17_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( keyence_net.Write( textBox8.Text, ulong.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button16_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( keyence_net.Write( textBox8.Text, float.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button15_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( keyence_net.Write( textBox8.Text, double.Parse( textBox7.Text ) ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button14_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                writeResultRender( keyence_net.Write( textBox8.Text, textBox7.Text ), textBox8.Text );
            }
            catch (Exception ex)
            {
                MessageBox.Show( ex.Message );
        ...
        private void button25_Click( object sender, EventArgs e )
        {
            try
            {
                OperateResult<byte[]> read = keyence_net.Read( textBox6.Text, ushort.Parse( textBox9.Text ) );
                if (read.IsSuccess)
                {
        ...
        private void ThreadReadServer()
        {
            while (isThreadRun)
            {
                ...
                try
                {
                    OperateResult<short> read = keyence_net.ReadInt16( textBox12.Text );
                    if (read.IsSuccess)
                    {
                        // 显示曲线
